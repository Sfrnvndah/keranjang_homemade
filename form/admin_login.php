<?php
    if (!isset($_SESSION)) {
        if (!defined('ADMIN_SESSION')) {
            define('ADMIN_SESSION', true);
            session_name('admin_session'); // Namespace khusus untuk admin
            session_start();
        }
    }
            ...
            <div class="login-form">
                ...
                <form action="admin_login.php" method="post">
                    ...
                    <p style="text-align: center;">
                        <a href="admin_forgot_password.php">Lupa Password?</a>
                    </p>
                </form>
                <div class="register-link">
                    <p>Belum punya akun? <a href="admin_register.php">Daftar</a></p>
                </div>
            </div>
        </div>
