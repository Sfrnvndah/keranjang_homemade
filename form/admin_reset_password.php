...
<body>
    <div class="login-container">
        <div class="login-form">
            ...
            <?php endif; ?>
            <form action="admin_reset_password.php?email=<?php echo urlencode($_GET['email'] ?? $_POST['email'] ?? ''); ?>&token=<?php echo urlencode($_GET['token'] ?? $_POST['token'] ?? ''); ?>&expire=<?php echo urlencode($_GET['expire'] ?? $_POST['expire'] ?? ''); ?>" method="POST">
